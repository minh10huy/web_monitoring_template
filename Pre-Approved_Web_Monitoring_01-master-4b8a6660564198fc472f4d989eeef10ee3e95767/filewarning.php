...
if (!isset($_SESSION['monitoring_username']) || $_SESSION['monitoring_username'] == null) {
    ...
    if ($_SESSION['monitoring_username'] != "admin" && $_SESSION['monitoring_username'] != "subadmin" && $_SESSION['monitoring_username'] != "sgb_monitoring" && $_SESSION['monitoring_username'] != "sgb_admin") {
...
<html>    
	...
	<div class="bs-docs-section" style="margin: 5px 460px"><a id='linkstop'  href='' onclick="stopSendEmail();"  class="btn btn-default" role="button" style="color:white; border:0;" >Stop</a></div>

	<div class="bs-docs-section" style="margin: 5px 460px"><a id='linkstart'  href='' onclick="startSendEmail();"  class="btn btn-default" role="button" style="color:white; border:0;" >Start</a></div>
