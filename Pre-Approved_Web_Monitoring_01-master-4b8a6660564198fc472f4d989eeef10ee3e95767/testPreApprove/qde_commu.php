...
if (!isset($_SESSION['monitoring_username']) || $_SESSION['monitoring_username'] == null) {
    ...
    if (isset($_GET['idF1'])) {
        ...
        $uploadPerDay = $vpBank->countUploadPerDay($ccCode, $date, "qde");
    ...
    <html>
        <head>
            ...
            <title>SAIGON BPO COMMUNICATION</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs" style="background:#fff;">
                                        <li class="active"><a href="#tab_qde" data-toggle="tab">QDE</a></li>
                                        ...
                                        <div class = "tab-pane active" id = "tab_qde">
                                            <div class = "muform">
                                                <table style="width: 900px; margin: 0px auto 50px auto; border: 1px #ccc solid; background: #fff; font-size: 11px; font-family: verdana, sans-serif;" align="center">
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="2" style="word-wrap: break-word; border:0px;padding: 9px; color: #fff; background: #F9A11B;">
                                                        ...
                                                        <tr style="padding: 10px;">
                                                            <td style="width: 900px; padding: 15px 0px 25px 25px; vertical-align: top;">
                                                                <div class = "form-style-10">
                                                                    <form id="adeForm" enctype = "multipart/form-data" action = "qde_commu.php" method = "POST" onsubmit = "return validateQDE()">
    <!--                                                                        <div class = "section"><span>1</span>QDE info</div>
                                                                        <div class = "inner-wrap">
                                                                            <label>Customer ID: <input type = "text" id = "cus_id" name = "cus_id" disabled value = <?php echo $cus_id; ?> > </label>
                                                                            <label>App ID (IDF1): <input type="text" id ="app_id" name="app_id" disabled value= <?php echo $idF1; ?>></label>
                                                                        </div>-->
                                                                        <!--<form id="adeForm">-->
                                                                        <div class="section"><span>1</span>Error Code</div>
                                                                        <div class="inner-wrap">                                                                          
                                                                        ...
                                                                        <div class="section"><span>2</span>Reason</div>
                                                                        <div class="inner-wrap">                                                                          
                                                                            <label>Reason: <textarea name="reason" id="reason" required="true"></textarea></label>
                                                                        </div>
                                                                        <?php if ($product_type == 1) { ?>																	
                                                                            <div class="section"><span>3</span>File &amp; Upload</div>
                                                                            <div class="inner-wrap">
                ...
                function validateQDE() {
                    ...
                    if (uploadFile != null && uploadFile != "") {
                        ...
                        if (file_name_valid.length === 4) {
                            ...
                            if (ccCode.length == 8) {
                                //                                if (!ccCode.startsWith("CC")) {
                                //                                    msg += "your id  must be start with \"CC\", \n";
                                //                                } else {
                                //                                    var id = ccCode.substr(ccCode.length - 6);
                                //                                    if (isNaN(id) || !(id.length == 6)) {
                                //                                        msg += "behind CC must be NUMERIC and 6 charater (ex: 100375), \n";
                                //                                    }
                                //                                }
                            ...
                            if (upTime.length != 2) {
                                //displayLog(Color.red, "the number of your upload per day is\"" + upTime + "\"" + ". Pls rename folder, ");
                                msg += "the number of upTime must 2 charater (ex: 01, 12) \n";
                            }
                            /*                             if (upTime !== "01" && upTime !== "1" && upTime !== "37" && upTime !== "38" && upTime !== "39" && upTime !== "40" && upTime !== "41" && upTime !== "42" && upTime !== "43" && upTime !== "44" && upTime !== "45" && upTime !== "46" && upTime !== "47" && upTime !== "48" && upTime !== "49") {
