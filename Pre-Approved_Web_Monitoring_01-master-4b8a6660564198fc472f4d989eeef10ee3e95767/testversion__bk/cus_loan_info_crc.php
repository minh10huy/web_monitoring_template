...
$cus_data = $vpBank->getCusDataCRC($mana_id);
                            ...
                            <div class="container">
                                ...
                                <table style="clear: both" class="table table-bordered table-striped" id="customers_info">
                                    <tbody> 
                                        ...
                                        <tr>         
                                            <td>Monthly Costs</td>
                                            <td><a data-title="Monthly Costs"  data-placeholder="Required" data-pk="1" data-type="text" id="chiphi_kh_bsung" href="#" class="topupEditable editable editable-click"><?php echo $cus_data[0]['chiphi_kh_bsung']; ?></a></td>
                                        </tr> 
                                        <tr>         
                                        ...
                                        <tr>         
                                            ...
                                            <td width="70%"><a data-title="Product Name" data-placeholder="Required" data-pk="1" data-type="text" id="product_name" href="#" class="topupEditable editable editable-click"><?php echo $cus_data[0]['product_name']; ?></a></td>
                                        </tr>
                                        <tr>         
                                            <td>Product Code</td>
                                            <td><a data-title="Product Code"  data-placeholder="Required" data-pk="1" data-type="text" id="product_code" href="#" class="topupEditable editable editable-click"><?php echo $cus_data[0]['product_code']; ?></a></td>
                                        </tr> 
                                        <tr>         
                                            <td>Offered Credit Limit</td>
                                            <td><a data-title="Offered Credit Limit" data-placeholder="Required" data-pk="1" data-type="text" id="offered_credit_limit" href="#" class="topupEditable editable editable-click"><?php echo $cus_data[0]['offered_credit_limit']; ?></a></td>
                                        </tr>                                                                                                                                                               
                                        <tr>         
                                            <td width="30%">Embossing Name</td>
                                            <td width="70%"><a data-title="Embossing Name" data-placeholder="Required" data-pk="1" data-type="text" id="embossing_name" href="#" class="topupEditable editable editable-click"><?php echo $cus_data[0]['embossing_name']; ?></a></td>
                                        </tr>
                                        <tr>         
                                            <td>Mailing Address</td>
                                            <td><a data-title="Mailing Address"  data-placeholder="Required" data-pk="1" data-type="text" id="mailing_address" href="#" class="topupEditable editable editable-click"><?php echo $cus_data[0]['mailing_address']; ?></a></td>
                                        </tr> 
                                        <tr>         
                                            <td>Answer for Security Question</td>
                                            <td><a data-title="Modified Fields" data-placeholder="Required" data-pk="1" data-type="text" id="answer_for_security_question" href="#" class="topupEditable editable editable-click"><?php echo $cus_data[0]['answer_for_security_question']; ?></a></td>
                                        </tr>                                            
                                    </tbody>
                                </table>
                            </div>
