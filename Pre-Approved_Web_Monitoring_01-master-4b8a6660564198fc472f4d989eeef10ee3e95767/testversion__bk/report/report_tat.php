                ...
                function drawTableAndChart(report_type) {
                    ...
                    switch (report_type) {
                        ...
                        case "6": // Hourly Downloaded Amount (Line Chart)
                            ...
                            // Create header for chart table build
                            header = ['Time', 'PL_Normal', 'PL_Mobile', 'QDE_Normal', 'QDE_Mobile', 'QDE_PL_PreApprove', 'QDE_CRC_PreApprove', 'PL Pre-Approve', 'CRC Pre-Approve'];
                            //buildHoursColumn();
                            report_div = "report-content-1";
                            table_id = "table-report-1";
                            break;
...
//                                else if ($th.text() == "Type"){
//                                    $(this).css({"background-color": "#79C753"});
////                                    if (num % 2 != 0) {
////                                        $(this).css({"background-color": "#034F84"});
////                                    }else{
////                                        $(this).css({"background-color": "#FAE03C"});
////                                    }
//                                }
                                else {
                                    if (num % 2 != 0) {
                                        $(this).css({"background-color": "#91A8D0"});
                                    }else{
                                        $(this).css({"background-color": "#98DDDE"});
                                    }
                                }
