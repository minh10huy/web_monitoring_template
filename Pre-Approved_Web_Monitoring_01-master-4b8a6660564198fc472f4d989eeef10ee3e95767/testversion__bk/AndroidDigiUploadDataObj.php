...
class AndroidDigiUploadDataObj {
    ...
    function checkUserLogin($username, $password, $device_model, $device_imei) {
...
//                    "where cc_code = " . "'" . $username . "'"); die;
            $stmt = $con->prepare("select cc_name, cc_password, channel, province, device_model, device_imei from " . $proj_schema . ".lookup_channel " .
