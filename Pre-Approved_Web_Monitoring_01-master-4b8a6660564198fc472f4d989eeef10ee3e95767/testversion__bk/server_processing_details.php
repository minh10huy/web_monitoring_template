...
switch ($type) {
    case "1" :
        $columns = array(
            ...
            array('db' => 'Size', 'dt' => 14),
            array('db' => 'Filename', 'dt' => 15),
            array('db' => 'Check', 'dt' => 16),
            array('db' => 'Classify user SG', 'dt' => 17),
            array('db' => 'Classify Speed', 'dt' => 18),
            array('db' => 'ID F1', 'dt' => 19),
            array('db' => 'User F1', 'dt' => 20),
            array('db' => 'DE user SG', 'dt' => 21),
            array('db' => 'DE Date', 'dt' => 22),
            array('db' => 'DE Time', 'dt' => 23),
            array('db' => 'Note', 'dt' => 24),
    ...
    case "3" :
        $columns = array(
            array('db' => '#', 'dt' => 0),
            array('db' => 'ID F1', 'dt' => 1),
            array('db' => 'Status F1', 'dt' => 2),
            array('db' => 'QDE Reason of Sale', 'dt' => 3),
            array('db' => 'Status SaigonBPO', 'dt' => 4),
            array('db' => 'Reason NOT OK', 'dt' => 5),
            array('db' => 'Opportunity Name', 'dt' => 6),
            array('db' => 'No. Agreement ID', 'dt' => 7),            
            array('db' => 'TSA Code F1', 'dt' => 8),
            array('db' => 'TSA Name', 'dt' => 9),
            array('db' => 'TSA Phone Number', 'dt' => 10),
            array('db' => 'Product Name 1', 'dt' => 11),
            array('db' => 'Product Code 1', 'dt' => 12),
            array('db' => 'Loan Amount Request', 'dt' => 13),
            array('db' => 'Loan Term Request', 'dt' => 14),
            array('db' => 'Insurance', 'dt' => 15),
            array('db' => 'Insurance Plus', 'dt' => 16),
            array('db' => 'Insurance Name', 'dt' => 17),            
            array('db' => 'Date of Closure', 'dt' => 18),
            array('db' => 'Disb Channel', 'dt' => 19),
            array('db' => 'Branch Code', 'dt' => 20),
            array('db' => 'Description', 'dt' => 21),                          
            array('db' => 'Referee 1', 'dt' => 22),
            array('db' => 'Referee 2', 'dt' => 23),
            array('db' => 'Spouse Name', 'dt' => 24),
            array('db' => 'CC Code', 'dt' => 25),
            array('db' => 'CC Name', 'dt' => 26),
            array('db' => 'DSA Code', 'dt' => 27),
            array('db' => 'DSA Name', 'dt' => 28),
            ...
            array('db' => 'Number of Modified Fields', 'dt' => 39),
            array('db' => 'Modified Fields', 'dt' => 40),
            array('db' => 'Download Time', 'dt' => 41),
            array('db' => 'management_id', 'dt' => 42)            
        );
