...
//            console.log("Value :" + value);
                        //console.log("check : "  + value);
                        if (value != "All" && value != "DSNTB" && value != "KGK" && value != "POS-CDL" && value != "RBA" && value != "RBC" && value != "RBD" 
                                && value != "RBK" && value != "TELE-NTB" && value != "TELE-TOPUP" && value != "TTU" && value != "POS" && value != "DGT" && value != "RBM"
                                    && value != "DMT1" && value != "DMT2" && value != "DMA" && value != "DML" && value != "DMB" && value != "DMC" && value != "DMD" && value != "DMK" && value != "DMM1" && value != "DMM2" && value != "TTU-XSTU" && value != "DMS-XSTU" && value != "DGT-XSTU")                        
                            return false;
                        ...
                        <form id="fm" method="post" novalidate>
                            ...
                            <div class="fitem" style="padding-top: 20px; padding-left: 10px;">
                                ...
                                <select id="combo_channel" class="easyui-combobox" name="channel" data-options="required:true,validType:'ChannelCheck'">
                                    ...
                                    <option value="DMT1">DMT1</option>
                                    <option value="DMT2">DMT2</option>
                                    ...
                                    <option value="DMM2">DMM2</option> 
                                    <option value="TTU-XSTU">TTU-XSTU</option>
                                    <option value="DMS-XSTU">DMS-XSTU</option>
                                    <option value="DGT-XSTU">DGT-XSTU</option> 									
                                </select>
                            </div>
                            <div class="fitem" style="padding-top: 20px; padding-left: 10px;">
