...
//                                drawTableAndChart("4");
    ...
    <?php } ?>
                ...
                function drawStatusTableCRC() {
                    $('#report-content-crc').html('<table id="table-status-crc" class="table table-bordered table-striped" width="100%">   <thead>      <tr>         <th>No.</th>         <th>Type</th>         <th>Status</th>         <th>09:00</th>         <th>10:00</th>         <th>11:00</th>         <th>12:00</th>         <th>13:00</th>         <th>14:00</th>         <th>15:00</th>         <th>16:00</th>         <th>17:00</th>         <th>18:00</th>         <th>19:00</th>         <th>20:00</th>         <th>21:00</th>         <th>22:00</th>	  <th>Sum</th>     </tr>   </thead></table>');
                    var table = $('#table-status-crc').DataTable({
                        "ajax": {
                            "url": "data_report.php",
                            "type": "POST",
                            "pagingType": "full_numbers",
                        ...
                        "drawCallback": function (oSettings) {
                            $('#table-status-crc').each(function () {
                        ...
                        "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                            ...
                            $(nRow).find('td').each(function (colIndex) {
                                var $th = $("#table-status-crc thead tr th").eq($(this).index());
                                if ($th.text() == "Sum"){
                                    $(this).css({"background-color": "#79C753"});
                                }else {
                                    if (num % 2 != 0) {
