...
switch ($type) {
    ...
    case "2" :
        ...
        $function = $getDataReportFunctionName->sp_get_data_report_qde_details_for_web_ntb;
        break;
    case "3" :
        $columns = array(
            array('db' => '#', 'dt' => 0),
    ...
    case "6" :
        $columns = array(
            ...
            array('db' => 'Loan Term Request', 'dt' => 15),
            array('db' => 'Insurance', 'dt' => 16),
            array('db' => 'Date of Closure', 'dt' => 17),
            array('db' => 'Disb Channel', 'dt' => 18),
            array('db' => 'Branch Code', 'dt' => 19),
            array('db' => 'Description', 'dt' => 20),
            array('db' => 'Referee 1', 'dt' => 21),
            array('db' => 'Referee 2', 'dt' => 22),
            array('db' => 'Spouse Name', 'dt' => 23),
            array('db' => 'CC Code', 'dt' => 24),
            array('db' => 'CC Name', 'dt' => 25),
            array('db' => 'DSA Code', 'dt' => 26),
            array('db' => 'DSA Name', 'dt' => 27),
            array('db' => 'New ID Card Number', 'dt' => 28),
            array('db' => 'Date of Issue', 'dt' => 29),
            array('db' => 'Place of Issue', 'dt' => 30),
            array('db' => 'New Phone', 'dt' => 31),
            array('db' => 'Address', 'dt' => 32),
            array('db' => 'Actual Address', 'dt' => 33),
            array('db' => 'Monthly Income', 'dt' => 34),
            array('db' => 'Monthly Costs', 'dt' => 35),
            array('db' => 'Monthly Income Family', 'dt' => 36),
            array('db' => 'Monthly Costs Family', 'dt' => 37),
            array('db' => 'Product Name', 'dt' => 38),
            array('db' => 'Product Code', 'dt' => 39),
            array('db' => 'Offered Credit Limit', 'dt' => 40),
            array('db' => 'Embossing Name', 'dt' => 41),
            array('db' => 'Mailing Address', 'dt' => 42),
            array('db' => 'Answer for Security Question', 'dt' => 43),
            array('db' => 'Card Insurance Type', 'dt' => 44),
            array('db' => 'Number of Modified Fields', 'dt' => 45),
            array('db' => 'Modified Fields', 'dt' => 46),
            array('db' => 'management_id', 'dt' => 47)
        );
    ...
    case "7" :
        ...
        $function = $getDataReportFunctionName->sp_get_data_report_qde_details_for_web_pl_pre;
        break;
    case "8" :
        $columns = array(
            array('db' => '#', 'dt' => 0),
        ...
        $function = $getDataReportFunctionName->sp_get_data_report_qde_details_for_web_crc_pre;
        break;
}
...
if ($type === "6" || $type === "8") {
    ...
    $con = $pgSQL->getConDPO_DIGISOFT(false);
}
