...
//            //$select_login = "SELECT count(*) FROM db_000_vpbank_0813.login_attempts WHERE username = '$username'";
//            $select_login = "SELECT count(*) FROM db_000_vpbank_0813.login_attempts WHERE username = :username";
//            $stmt = $con->prepare($select_login);
//            $stmt->execute(array('username' => $username));
//            $data = $stmt->fetch();
//            if ($data[0] > 0)
//                //$sql = "UPDATE db_000_vpbank_0813.login_attempts SET lastlogin = NOW() WHERE username = '$username'";
//                $sql = "UPDATE db_000_vpbank_0813.login_attempts SET lastlogin = NOW() WHERE username = :username";
//            else
//                //$sql = "INSERT INTO db_000_vpbank_0813.login_attempts(lastlogin, username) VALUES(NOW(), '$username')";
//                $sql = "INSERT INTO db_000_vpbank_0813.login_attempts(lastlogin, username) VALUES(NOW(), :username)";
//            $prepare = $con->prepare($sql);
//            $prepare->execute(array('username' => $username));
//            if ($numRows > 0) {
//                // Update acitve time as well as status if login successfully
//                //$sql = "UPDATE db_000_vpbank_0813.login_attempts SET is_loggedin = 1 WHERE username = '$username'";
//                $sql = "UPDATE db_000_vpbank_0813.login_attempts SET is_loggedin = 1 WHERE username = :username";
//                $stmt = $con->prepare($sql);
//                $stmt->execute(array('username' => $username));
//                
