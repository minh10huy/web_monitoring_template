...
if (isset($mana_id)) {
    ...
    if ($cus_data[0]['qde_managementid'] !== '' && $cus_data[0]['qde_managementid'] != NULL) {
        $is_work = $vpBank->check_mana_id_work($cus_data[0]['qde_managementid']);
        $qde_data = $vpBank->getCusDataQDE($cus_data[0]['qde_managementid']);
    }
    if($_SESSION['monitoring_userrole'] === "admin" || $_SESSION['monitoring_userrole'] === "subadmin"){
    $data_update_history = $vpBank->getHistoryUpdateData($mana_id);
    }	
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
													...
													<input type="text" id="insurance_plus_org" name="insurance_plus_org" value="<?php echo $cus_data[0]['insurance_plus']; ?>" class="hidden">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                        </div> 
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
													...
													<input type="text" id="insurance_name_org" name="insurance_name_org" value="<?php echo $cus_data[0]['insurance_name']; ?>" class="hidden">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                        </div>                                          
