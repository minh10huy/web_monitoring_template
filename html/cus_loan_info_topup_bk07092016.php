...
if (isset($mana_id)) {
    ...
    if (isset($cus_data[0]['id_f1']) && $cus_data[0]['id_f1'] !== '') {
        $qde_history = $vpBank->getQDEHistory($cus_data[0]['id_f1']);
    }
	$is_work = $vpBank->check_mana_id_work($mana_id);
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <?php } ?>
                                    <?php if (($cus_data[0]['id_f1'] != null && $cus_data[0]['id_f1'] != '' && !$cus_data[0]['is_have_qde']) || ($cus_data[0]['capture_status'] == 5 && $cus_data[0]['bad_status'] == 0)) { ?>
                                        <li><a data-toggle="tab" href="#tab_3"><strong> QDE </strong></a></li> 
                                    <?php } ?>
                                    <?php if (($cus_data[0]['id_f1'] != null && $cus_data[0]['id_f1'] != '' && $cus_data[0]['is_have_qde']) && ($cus_data[0]['capture_status'] !== 5 && $cus_data[0]['bad_status'] !== 2)&&  count($is_work) === 0){?>
                                ...
                                <div class="tab-content">
                                    <div id="tab_1" class="tab-pane active">
                                        ...
                                        <?php if (count($qde_history) > 0) { ?>
                                            <div class="box box-primary">
                                                <label>Lịch sử QDE:</label>
                                                <div class="box-body">
                                                    <?php for ($i = 0; $i < count($qde_history); $i++) { ?>
                                                        <label>QDE lần <?php echo $i+1; ?>:</label>
                                                        <ul class="sidebar-menu">
                                        ...
                                        <?php if (($cus_data[0]['id_f1'] != null && $cus_data[0]['id_f1'] != '' && !$cus_data[0]['is_have_qde']) || ($cus_data[0]['capture_status'] == 5 && $cus_data[0]['bad_status'] == 0)) { ?>
                                            ...
                                            <!-- /.tab-pane -->                                        
                                        <?php } else if (($cus_data[0]['id_f1'] != null && $cus_data[0]['id_f1'] != '' && $cus_data[0]['is_have_qde']) && ($cus_data[0]['capture_status'] !== 5 && $cus_data[0]['bad_status'] !== 2)&&  count($is_work) === 0){?>
