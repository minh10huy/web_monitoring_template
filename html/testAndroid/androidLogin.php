...
if (count($results) > 0 && $results["cc_password"] === $password && $results["security_key"] === $security_key && $results["is_enable"]) {//&& $results["device_imei"] === $device_imei
...
} elseif (count($results) > 0 && $results["cc_password"] === $password && !$results["is_enable"] ) {//&& $results["device_imei"] === $device_imei
