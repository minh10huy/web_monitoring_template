...
class GetDataReportFunctionName {
    ...
    var $sp_get_data_report_general_zapin;
    var $sp_get_data_report_details_zapin;    
...
//        $this->sp_get_data_report_details_preapprove = "sp_get_data_report_pre_approve_topup_details_for_web";
        ...
        $this->sp_get_data_report_general = "sp_get_data_report_hosomoi_general_for_web";
//        $this->sp_get_data_report_details = "sp_get_data_report_hosomoi_details_for_web";
        $this->sp_get_data_report_details = "sp_get_data_report_hosomoi_details_for_web_hdhy_test";
...
//        $this->sp_get_data_report_details_mobile_newapp = "sp_get_data_report_hosomoi_details_mobile";
        $this->sp_get_data_report_details_mobile_newapp = "sp_get_data_report_hosomoi_details_mobile_hdhy_test";
        
        $this->sp_get_data_report_general_zapin = "sp_get_data_report_hosomoi_general_for_web_zapin";
        $this->sp_get_data_report_details_zapin = "sp_get_data_report_hosomoi_details_for_web_zapin"; 
        
        // QDE - report
        $this->sp_get_data_report_general_form3_zapin = "sp_get_data_report_qde_general_for_web_zapin";
        $this->sp_get_data_report_details_form3_zapin = "sp_get_data_report_qde_details_for_web_zapin";        
    }
}
