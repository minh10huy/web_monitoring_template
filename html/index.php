            ...
            <div class="box-body" style="height: 45px; background:#e4ffde;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group"> 
                            <div class="input-group">
                                <label>Từ ngày:</label>
                                <input type="text" id="txtFromDate" value="<?php echo date("d/m/Y") ?>" style="width: 100px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" id="txtToDate" value="<?php echo date("d/m/Y") ?>" style="width: 100px;">      
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="input-group">
                                ...
                                <?php if ($_SESSION['monitoring_userrole'] == 'admin') { ?>
                                    <select onchange="" id="slType" name="slType">
                                        ...
                                        <option value="2">QDE NTB</option>
                                        <option value="3">PL PreApprove</option>
                                        <option value="7">QDE PL TopUp</option>
                                        <option value="6">CRC PreApprove</option>
                                        <option value="8">QDE CRC</option>
                    ...
                    <div class="col-lg-1">
                        <div class="form-group">
                            <div class="input-group">
                                <button class="btn btn-primary fa" type="button" id="filter-btn"> Tìm kiếm</button>                             
                            </div>   
                        </div>
                    </div>
                    ...
                    <?php if ($_SESSION['monitoring_userrole'] == 'admin' || $_SESSION['monitoring_userrole'] == 'subadmin') { ?>
                        <div class="col-lg-1">
                            <div class="form-group">
                                <div class="input-group">                           
                                    <button class="btn btn-primary fa" type="button" id="btnExport" name="btnExport"> Xuất file Excel</button>                                                            
                                </div>   
                            </div>
                        </div>  
                    <?php } ?> 
                                    ...
                                    <ul id="tab-display" class="nav nav-tabs">
                                        ...
                                        <li class="pull-right">
                                            <select id="dropdown_status">
                                                ...
                                                <option value="Done - Xử lý">Done - Xử lý</option>
