...
order by d.id desc";
    ...
    function resetPassword($user) {
        ...
        try {
            ...
            $stmt = $con->prepare("update $proj_schema.lookup_channel set cc_password = '" . md5("123456") . "' where cc_code = '" . $user . "';");
...
//                    "'" . $cc_code . "', '" . $file_name . "', '" . $idF1 . "', '". $cus_name . "', '" . $cus_id . "', '". $reason . "')");die;
            if ($type == 3) {
                $stmt = $con->prepare("insert into " . $proj_schema . ".upload_qde" . "(cc_code, file_name, id_f1, cus_name, cus_id_number, reason, is_pre_approved, qde_type, qde_type_code) VALUES (" .
                        "'" . $cc_code . "', '" . $file_name . "', '" . $idF1 . "', '" . pg_escape_string($cus_name) . "', '" . $cus_id . "', '" . $reason . "', 1, 1, '".$qde_type_code."')");
            } elseif ($type == 6) {
                $stmt = $con->prepare("insert into " . $proj_schema . ".upload_qde" . "(cc_code, file_name, id_f1, cus_name, cus_id_number, reason, is_pre_approved, qde_type) VALUES (" .
                        "'" . $cc_code . "', '" . $file_name . "', '" . $idF1 . "', '" . pg_escape_string($cus_name) . "', '" . $cus_id . "', '" . $reason . "', 1, 2)");
            } else {
