...
function initializeDetailsTable(type_input) {
    switch (type_input) {
        ...
        case "2":
            ...
            break;
        case "3":
            document.getElementById("tab_details").innerHTML = '<table id="tablePreApproveDetails" class="table table-bordered table-striped" width="100%"><thead><tr><th>#</th><th>ID F1</th> <th>Status F1</th> <th>QDE Reason of Sale</th> <th>Status SaigonBPO</th><th>Reason NOT OK</th> <th>Opportunity Name</th><th>No. Agreement ID</th> <th>TSA Code F1</th><th>TSA Name</th><th>TSA Phone Number</th><th>Product Name 1</th><th>Product Code 1</th><th>Loan Amount Request</th> <th>Loan Term Request</th><th>Insurance</th><th>Insurance Plus</th><th>Insurance Name</th><th>Date of Closure</th> <th>Disb Channel</th><th>Branch Code</th>   <th>Description</th> <th>Referee 1</th>   <th>Referee 2</th>   <th>Spouse Name</th><th>CC Code</th><th>CC Name</th> <th>DSA Code</th> <th>DSA Name</th> <th>New ID Card Number</th> <th>Date of Issue</th><th>Place of Issue</th><th>New Phone</th><th>Address</th><th>Actual Address</th><th>Monthly Income</th><th>Monthly Costs</th> <th>Monthly Income Family</th><th>Monthly Costs Family</th><th>Number of Modified Fields</th><th>Modified Fields</th> <th>Download Time</th> <th>management_id</th></tr></thead></table>';
//        $.ajax({
//            type: "POST",
...
//        });            
            ...
            $('#dropdown_status').on('change', function () {
                ...
                if (this.value == '') {
                    ...
                    table2.column(4).search(regExSearch, true, false).draw();
                }
            });
