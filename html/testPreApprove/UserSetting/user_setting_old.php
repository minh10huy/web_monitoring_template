...
//            console.log("Value :" + value);
                        //console.log("check : "  + value);
                        if (value != "All" && value != "DSNTB" && value != "KGK" && value != "POS-CDL" && value != "RBA" && value != "RBC" && value != "RBD" && value != "RBK" && value != "TELE-NTB" && value != "TELE-TOPUP" && value != "TTU" && value != "POS")
                            return false;
...
<?php } ?>
                ...
                $('#fm_imei').form('submit', {
                    ...
                    success: function (result) {
                        ...
                        if (result.errorMsg) {
                            ...
                            $.messager.alert('Info', "IMEI number has been inserted successfully", 'info');
                        }
                    }
                });
            }
            ...
            function addImeiNumber() {
                $('#dlg_imei').dialog('open').dialog('setTitle', 'Add IMEI');
                $('#fm_imei').form('clear');
                url = 'save_imei.php';
            }
...
<?php if ($_SESSION['monitoring_userrole'] != "teamleader") { ?>    
                            ...
                            <a id="add_imei" href="#" class="easyui-linkbutton" iconCls="icon-imei" plain="true" onclick="addImeiNumber()">Add IMEI</a>
...
<?php } ?>                   
                ...
                <div id="dlg_imei" class="easyui-dialog" style="width:350px;height:250px;"
                    ...
                    <form id="fm_imei" method="post" novalidate>
                        <div class="fitem" style="padding-top: 20px; padding-left: 10px;">
                            <label style="float: left;">Device Model:</label>
                            <input name="device_model" class="easyui-textbox" style="width:100px;" data-options="required:true">
                        </div>

                        <div class="fitem" style="padding-top: 20px; padding-left: 10px;">
                            <label style="float: left;">IMEI Number:</label>
                            <input id="im_no" name="device_imei" class="easyui-textbox" maxlength="15" data-options="required:true,validType:'minLength[15]'">
                        </div>
                        <div class="fitem" style="padding-top: 20px; padding-left: 10px;">
