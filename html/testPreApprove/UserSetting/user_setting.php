...
//            console.log("Value :" + value);
                        //console.log("check : "  + value);
                        if (value != "All" && value != "DSNTB" && value != "KGK" && value != "POS-CDL" && value != "RBA" && value != "RBC" && value != "RBD" && value != "RBK" && value != "TELE-NTB" && value != "TELE-TOPUP" && value != "TTU" && value != "POS" && value != "DGT" && value != "RBM")
                            return false;
                        return true;
                    },
                    message: 'This field is required.'
