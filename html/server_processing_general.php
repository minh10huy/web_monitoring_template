...
switch ($type) {
    ...
    case "2" :
        ...
        $function = $getDataReportFunctionName->sp_get_data_report_qde_general_for_web_ntb;
        break;
    case "3" :
        $columns = array(
            array('db' => 'Day', 'dt' => 0),
            array('db' => 'Done - Xử lý', 'dt' => 1),
    ...
    case "7" :
        ...
        $function = $getDataReportFunctionName->sp_get_data_report_qde_general_for_web_pl_pre;
        break;
    case "8" :
        $columns = array(
            array('db' => '#', 'dt' => 0),
        ...
        $function = $getDataReportFunctionName->sp_get_data_report_qde_general_for_web_crc_pre;
        break;
}
